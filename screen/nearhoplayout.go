...
var _ fyne.Layout = (*nearhopLayout)(nil)

type nearhopLayout struct {
}

// NewMaxLayout creates a new MaxLayout instance
func NewNearhopLayout() fyne.Layout {
	return &nearhopLayout{}
}

// Layout is called to pack all child objects into a specified size.
// For MaxLayout this sets all children to the full size passed.
func (g *nearhopLayout) Layout(objects []fyne.CanvasObject, size fyne.Size) {
}

func (g *nearhopLayout) MinSize(objects []fyne.CanvasObject) fyne.Size {
