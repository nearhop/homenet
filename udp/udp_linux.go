...
func NewListener(l *logrus.Logger, ip string, port int, multi bool, batch int) (*Conn, error) {
	...
	if err = unix.Bind(fd, &unix.SockaddrInet6{Addr: lip, Port: port}); err != nil {
		return nil, fmt.Errorf("unable to bind to socket %s: %s", ip, err)
	}
...
func (u *Conn) Close() {
	u.l.Error("Closing socket...............................")
	err := unix.Close(u.sysFd)
	if err != nil {
		u.l.Error("Closing socket...............................", err)
	} else {
		u.l.Error("Successfully Closed socket...............................")
	}
}
...
func Udp2ip(addr *Addr) net.IP {
	return addr.IP
}

func UdpPort(addr *Addr) uint16 {
	return addr.Port
}
