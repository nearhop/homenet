...
func newWaterTun(l *logrus.Logger, cidr *net.IPNet, defaultMTU int, routes []Route, dns []net.IP) (*waterTun, error) {
...
func (t *waterTun) AddRoutes(Routes []Route) error {
	return nil
}
...
func (t *waterTun) GetPlatformName() string {
	return "waterTun"
}
